    ...
    <div class="row">
      <div class="col-12 col-md-5">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            @foreach ($bookposts as $books)
            <tr>
              <td colspan="4">{{$books->post_title}}</td>
              <td> <a href="/updateview/{{$books->ID}}" class="badge badge-warning badge-pill">Update</a></td>
              <td><a href="/delete/{{$books->ID}}" class="badge badge-danger badge-pill">Delete</a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
